        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show:false }">
                ...
                <div x-show="show" class="py-2 absolute font-semibold bg-gray-100 mt-2 rounded-xl z-50 min-w-full w-max" style="display:none">
                    ...
                    <a href="/" 
                        class="block text-left text-sm px-3 leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white border-b-2">
                       All
                    </a>  
                    
                    @foreach ($categories as $category)  
                    <a href="/categories/{{ $category->slug }}" 
                        class="block text-left text-sm px-3 leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white 
